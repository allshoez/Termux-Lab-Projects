...
textarea { width:100%; height:200px; padding:10px; font-family:monospace; font-size:14px; border-radius:8px; border:1px solid #5eead4; background:#0f1e4d; color:#fff; box-sizing:border-box; }
...
function copyCode() {
  ...
  navigator.clipboard.writeText(code).then(()=>{alert("Kode berhasil disalin!");})
...
if __name__ == "__main__":
    # Jalankan Flask di thread supaya bisa lanjut buka Chrome
    def run_flask():
